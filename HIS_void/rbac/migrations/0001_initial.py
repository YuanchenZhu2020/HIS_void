# Generated by Django 3.1.7 on 2021-05-10 04:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('obj_permissions', models.ManyToManyField(blank=True, help_text='该角色拥有的对象资源权限', related_name='role_set', related_query_name='role', to='rbac.ObjectPermission', verbose_name='对象资源权限')),
            ],
            options={
                'verbose_name': '角色',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='以 6 位数字的工号作为登录账户名。', max_length=6, unique=True, verbose_name='登录账号')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('obj_permissions', models.ManyToManyField(blank=True, help_text='该用户组拥有的对象资源权限', related_name='usergroup_set', related_query_name='usergroup', to='rbac.ObjectPermission', verbose_name='对象资源权限')),
                ...
                ('url_permissions', models.ManyToManyField(blank=True, help_text='用户组具有的全部URL访问权限。', related_name='usergroup_set', related_query_name='usergroup', to='rbac.URLPermission', verbose_name='URL访问权限')),
            ],
            options={
                'verbose_name': '用户组',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='该用户拥有的对象资源权限', related_name='user_set', related_query_name='user', to='rbac.ObjectPermission', verbose_name='对象资源权限'),
        ),
        migrations.AddField(
            model_name='permissionsmixin',
            name='roles',
        ...
        migrations.AddField(
            model_name='permissionsmixin',
            name='url_permissions',
            field=models.ManyToManyField(blank=True, help_text='该用户具有的所有URL访问权限。', related_name='user_set', related_query_name='user', to='rbac.URLPermission', verbose_name='URL访问权限'),
        ),
        migrations.CreateModel(
            name='LoginLog',
            fields=[
