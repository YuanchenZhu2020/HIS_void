<<<<<<< HEAD:HIS_void/outpatient/migrations/0002_auto_20210522_1541.py
...
>>>>>>> 完成了处方开具分页中的药品提交和检查检验中的检验提交，其中检验提交的方式后续能会重做为ajax提交，目前仍为form提交:HIS_void/outpatient/migrations/0002_auto_20210517_1554.py
