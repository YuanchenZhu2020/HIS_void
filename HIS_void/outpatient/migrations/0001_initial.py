    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prescription_date', models.DateTimeField(auto_now_add=True, verbose_name='开具时间')),
                ('medicine_num', models.PositiveIntegerField(verbose_name='药品种类数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diagnosis_status', models.IntegerField(choices=[(0, '待诊'), (1, '诊中'), (2, '完毕')], default=0, verbose_name='诊疗状态')),
            ],
            options={
                'verbose_name': '挂号信息',
