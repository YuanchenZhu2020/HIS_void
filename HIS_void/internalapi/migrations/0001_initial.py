    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(editable=False, verbose_name='订单时间')),
                ('item_type', models.IntegerField(choices=[(0, '检查检验'), (1, '手术'), (2, '处方'), (3, '出院结算')], help_text='不同项目类型对应着不同的表，例如检查检验表、手术信息表、处方表等。', verbose_name='项目类型')),
