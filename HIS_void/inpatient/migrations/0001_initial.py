...
<<<<<<< HEAD
                ('bed_id', models.PositiveIntegerField(null=True, verbose_name='床位号')),
=======
...
>>>>>>> nurse-workspace
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital_reg', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nursing_record_set', related_query_name='nursing_records', to='inpatient.hospitalregistration', verbose_name='入院记录')),
            ],
            options={
                'verbose_name': '护理记录',
