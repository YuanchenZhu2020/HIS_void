...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('url_perm', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='rbac.urlpermission', verbose_name='URL访问权限')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('past_illness', models.TextField(blank=True, null=True, verbose_name='既往史')),
                ('allegic_history', models.TextField(blank=True, null=True, verbose_name='过敏史')),
            ...
            managers=[
                ('objects', patient.models.PatientUserManager()),
            ],
        ),
    ]
