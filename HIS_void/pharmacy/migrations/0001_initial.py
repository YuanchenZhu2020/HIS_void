    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine_id', models.CharField(max_length=6, unique=True, verbose_name='药品编号')),
                ('batch_num', models.PositiveIntegerField(unique=True, verbose_name='批次编号')),
                ...
                ('overdue_date', models.DateField(verbose_name='过期日期')),
