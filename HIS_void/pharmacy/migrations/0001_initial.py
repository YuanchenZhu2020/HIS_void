...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='MedicineInfo',
            fields=[
                ('medicine_id', models.CharField(max_length=6, primary_key=True, serialize=False, unique=True, verbose_name='药品编号')),
                ...
                ('shelf_day', models.PositiveIntegerField(verbose_name='保质期')),
                ('special', models.IntegerField(choices=[(1, '麻醉药品'), (2, '精神药品'), (3, '毒性药品'), (4, '放射性药品'), (0, '普通药品')], default=0, verbose_name='特殊标识')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_date', models.DateField(unique=True, verbose_name='采购日期')),
